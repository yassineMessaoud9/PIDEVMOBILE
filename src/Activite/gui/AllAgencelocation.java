...
public class AllAgencelocation extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllAgencelocation(Resources res) {
        super("Activite", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Agences Locations");
...
//        addTab(swipe, res.getImage("location.jpg"), spacer1, "  ", "", " ");
        ...
        Ajouter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                new AddAgencelocation(res, current).show();
            }
        });
        ButtonGroup barGroup = new ButtonGroup();
        Container co = new Container(BoxLayout.xCenter());;
        ArrayList<Agencelocation> Agencelocation = new ArrayList();
        Service sa = new Service();
        Agencelocation = sa.getAllAgence();
        Label i = new Label("La liste des agences");
        add(i);
        for (Agencelocation fi : Agencelocation) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("ID : " + fi.getIdAgence());
            Label l2 = new Label("Nom : " + fi.getNomAgence(), "SmallLabel");
            Label l3 = new Label("Adresse : " + fi.getAddressAgence(), "SmallLabel");
            Label l4 = new Label("Contact : " + fi.getContactAgence(), "SmallLabel");

            Label o = new Label("__________________________________");
            add(o);
            ...
            Modif.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent evt) {
                    Agencelocation r = new Agencelocation();

                    System.out.println(fi);

                    new modifyagence(res, fi).show();
            ...
            Supprimer.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    if (Dialog.show("Confirmation", "Voulez vous supprimer cette Activite ?", "Oui", "Annuler")) {
                        ...
                        /*    if( Service.getInstance().deleteAgence(fi.getIdAgence()))
                            {
