...
public class ListeUtilisateurs extends BaseForm {
    ...
    public ListeUtilisateurs(Resources res) {
        ...
        Utilisateur = sa.getAllUtilisateur();

        for (Utilisateur fi : Utilisateur) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("Nom: "+ fi.getNom() + "|| Prenom :"+fi.getPrenom() + "|| Email :"+fi.getEmail() + "|| Adresse :"+fi.getAdresse()+"|| Pays :"+fi.getPays()+"|| Role:"+fi.getRole()+"|| Status:"+fi.isActive());
