...
public class AllHotel extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllHotel(Resources res) {
        ...
        addTab(swipe, res.getImage("hotelmobile.jpg"), spacer1, "  ", "", " ");
         */
        ...
        for (Hotel fi : Hotel) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("ID : " + fi.getIdhotel());
            Label l2 = new Label("Nom : " + fi.getNomhotel(), "SmallLabel");
            Label l3 = new Label("adresse : " + fi.getAdresse(), "SmallLabel");
            Label l4 = new Label("etoile : " + fi.getEtoile(), "RedLabel");
            Label l5 = new Label("photo  : " + fi.getPhoto());
            // ct.add(l);
            ct.add(l2);
            ct.add(l3);
            ct.add(l4);
            ...
            pdf.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if (Dialog.show("Confirmation", "Voulez vous imprimer ces hotel en pdf ?", "Oui", "Annuler")) {
            ...
            Supprimer.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    if (Dialog.show("Confirmation", "Voulez vous supprimer cette Activite ?", "Oui", "Annuler")) {
                        ...
                        if (Service.getInstance().deleteActiviteHotel(fi.getIdhotel())) {
