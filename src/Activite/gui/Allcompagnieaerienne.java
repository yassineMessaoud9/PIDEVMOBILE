...
public class Allcompagnieaerienne extends BaseForm {

    Form current;
    ImageViewer imgv;

    public Allcompagnieaerienne(Resources res) {
        super("Activite", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("compagnieaerienne");
...
*/
        ...
        addTab(swipe, res.getImage("compagnie.jpg"), spacer1, "  ", "", " ");
        ...
        Button Ajouter = new Button("Send Mail");
        ...
        Ajouter.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent evt) {
                ...
                new SendMail(res, current).show();
            }
        });
        ButtonGroup barGroup = new ButtonGroup();
        Container co = new Container(BoxLayout.xCenter());;
        ArrayList<compagnieaerienne> compagnieaerienne = new ArrayList();
        Service sa = new Service();
        compagnieaerienne = sa.getAllcompagnie();

        for (compagnieaerienne fi : compagnieaerienne) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("ID : " + fi.getIdcompagnie());
            Label l2 = new Label("nomcompagnie : " + fi.getNomcompagnie(), "SmallLabel");
            Label l3 = new Label("payscompagnie : " + fi.getIdadresse().getPaysadresse(), "SmallLabel");
