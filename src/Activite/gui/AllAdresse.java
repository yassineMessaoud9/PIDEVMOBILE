...
public class AllAdresse extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllAdresse(Resources res) {
        super("Adresse", BoxLayout.y());
        ...
        addTab(swipe, res.getImage("adresse.jpg"), spacer1, "  ", "", " ");
        ...
        Ajouter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                new AddAdresse(res, current).show();
            }
        });
        ...
        Adresse = sa.getAllActivites();

        for (Adresse fi : Adresse) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("ID : " + fi.getIdadresse());
            Label l2 = new Label("Pays : " + fi.getPaysadresse(), "SmallLabel");
            Label l3 = new Label("Rue : " + fi.getRueadresse(), "SmallLabel");
            Label l4 = new Label("Contact : " + fi.getContactadresse(), "SmallLabel");
            ...
            l3.getAllStyles().setFgColor(5540035);
            l4.getAllStyles().setFgColor(5540035);
            ct.add(l);
            ct.add(l2);
            ct.add(l3);
            ct.add(l4);
            ...
            Supprimer.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    if (Dialog.show("Confirmation", "Voulez vous supprimer cette Activite ?", "Oui", "Annuler")) {
                        ...
                        if (Service.getInstance().deleteActivite(fi.getIdadresse())) {
                            Dialog.show("Success", "supprimer", new Command("OK"));
                            new AllAdresse(res).show();
                        }
