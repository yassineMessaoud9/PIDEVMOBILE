 ...
 * @author MediaHelp
 */
public class AllreservationHotels  extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllreservationHotels(Resources res) {
...
//        addTab(swipe, res.getImage("reser.jpg"), spacer1, "  ", "", " ");
...
/*        rbs[0].setSelected(true);
        ...
        Ajouter.addActionListener(new ActionListener() {
            ...
            //   new addHotel(res, current).show();
            }
        });
        ButtonGroup barGroup = new ButtonGroup();
        Container co = new Container(BoxLayout.xCenter());;
        ArrayList<ReservationHotel> ReservationHotel = new ArrayList();
        Service sa = new Service();
        ReservationHotel = sa.getAllActivitesHotel();

        for (ReservationHotel fi : ReservationHotel) {
            ...
            /* Image i = URLImage.createToStorage(encImage, "fileNameInStoragez" + fi.getImage(),url, URLImage.RESIZE_SCALE);
                                ...
                                imgv.setImage(i);
                                ct.add(imgv);*/
            Label l = new Label("ID : " + fi.getIdReservationHotel());
            Label l2 = new Label("typechambre : " + fi.getTypeChambre(), "SmallLabel");
              Label l3 = new Label("nbrnuit : "+fi.getNbrNuit(),"SmallLabel");
                            Label l4 = new Label("nbrpersonne : "+fi.getNbrPersonne(),"RedLabel");
                            Label l5 = new Label("idu  : "+fi.getIdU());
                                                        Label l6 = new Label("nom : "+fi.getIdTourisme().getNomhotel(),"RedLabel");
                  ...
                  if( Service.getInstance().deleteActivite(fi.getId_a()))
                            {
                                ...
                                new AllreservationHotels(res).show();
                            }
