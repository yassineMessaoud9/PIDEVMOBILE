...
public class AllPlatYM extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllPlatYM(Resources res) {
...
*/
        ...
        addTab(swipe, res.getImage("backg.jpg"), spacer1, "  ", "", " ");
        ...
        for (Plat fi : Plat) {
            ...
            Label l2 = new Label("Nom: " + fi.getNomPlat(), "SmallLabel");
                   Label l3 = new Label("Desc : " + fi.getDescription(), "SmallLabel");
                          Label l4 = new Label("Prix: " + fi.getPrixPlat(), "SmallLabel");
           ...
           public void actionPerformed(ActionEvent evt) {               
            ...
            public void actionPerformed(ActionEvent evt) {               
                if (Dialog.show("Confirmation", "Voulez vous supprimer cette Activite ?", "Oui", "Annuler")) {
                  ...
                  if( Service.getInstance().deletePlat(fi.getIdPlat()))
                            {
                                Dialog.show("Success","supprimer",new Command("OK"));
                                new AllPlatYM(res).show();
                            }
